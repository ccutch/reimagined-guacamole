...
const IssueDetails: React.FC<IssueDetailsProps> = ({ issueKey: key, close, onRefresh }) => {
    ...
    return (
        <>
            ...
            <div className='z-50 fixed right-0 bg-white shadow-2xl max-w-screen-sm w-full h-screen overflow-hidden flex flex-col'>
                <header className='flex items-center px-8 py-10 font-bold text-xl text-gray-600'>
                ...
                <div className="overflow-y-scroll">
                    <div className='flex flex-col py-4 px-8 bg-gray-50'>
                    ...
                    <div className='p-8'>
                        <div className="overflow-x-auto">
                            {details?.issue?.body && (
                                <ReactMarkdown className="mt-4 font-bold text-md text-gray-400 whitespace-pre">
                                    {details.issue.body}
                                </ReactMarkdown>
                            )}
                        </div>
